"""
Django settings for neverdrugs project.
...
ALLOWED_HOSTS = ['django-never-drugs.herokuapp.com','localhost', '127.0.0.1', 'www.neverdrugs.io']
...
WSGI_APPLICATION = 'neverdrugs.wsgi.application'
